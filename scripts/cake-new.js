...
async function requestMicrophonePermission() {
    ...
    try {
        ...
        introLabel.style.color = '#7A294E'; // Reset color
       ...
       micBtn.textContent = 'Continue';
        introLabel.textContent = `You're all set. Let's begin.`;        introLabel.classList.add('success');
        introLabel.style.color = '#7A294E';
...
micBtn.addEventListener('click', function(e) {
    ...
    if (micPermissionGranted) {
        // Permission has already been granted, so now continue.
        hideIntro();
    } else {
...
function startBlowDetection() {
    ...
    initMicrophone().then(success => {
        ...
        happyBirthday.textContent = 'Blow the candle!';
        ...
        function checkBlow() {
            ...
            if (isBlowing) {
                ...
                if (blowCounter === 1) {
                    ...
                    instructionMessage.textContent = 'Blow harder!';
                    instructionMessage.classList.add('visible');
                    instructionMessage.style.opacity = '1';
                }
